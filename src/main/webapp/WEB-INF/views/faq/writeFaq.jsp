						...
						<form action="faqInsert" method="post"
							...
							<table class="table-qna-img m-b-20">
								<tbody>
									...
									<tr class="table_head">
										<td class="column-1"><input type="file" id="faq_img" name="files"
											onchange="faq_previewImages();" multiple="multiple"></td>
									</tr>
									<tr class="table_row">
...
<script>
	function faq_previewImages() {
		...
		var previewContainer = document.getElementById('faq_imagePreviewContainer');
