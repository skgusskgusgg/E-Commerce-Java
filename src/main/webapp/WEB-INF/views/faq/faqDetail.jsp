...
<div class="container">
	<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
		...
		</a> <a href="qna.html" class="stext-109 cl8 hov-cl1 trans-04"> Help </a>
	</div>
</div>
			...
			<div class="col-md-8 col-lg-9 p-b-80"
				...
				<div class="p-r-45 p-r-0-lg">
					<div class="p-t-32">
						...
						</span> <c:if test="${mVO.id == faqDetail.user_id}">
					...
					<div class="p-t-40">
						...
						<c:forEach items="${reply}" var="reply">
							<div class="flex-w flex-m stext-111 cl2 p-b-19">
								...
								<div class="m-l-auto">
									<c:if test="${mVO.id == reply.user_id}">
										<button
											class="flex-c-m stext-101 cl5 size-127 bg2 bor18 hov-btn3 p-lr-15 trans-04"
											onclick="toggleEditForm('${reply.reply_no}', '${reply.comment}')">수정</button>
									</c:if>
								</div>
								<div class="m-l-8">
									<c:if test="${mVO.id == reply.user_id}">
										<form action="faqReplyDelete" method="post">
											<input type="hidden" name="reply_no"
												...
												name="faqId" value="${reply.faqId}" /> <input
												class="flex-c-m stext-101 cl5 size-127 bg2 bor18 hov-btn3 p-lr-15 trans-04"
								...
								<form action="faqReplyUpdate" method="post">
									...
									<div style="display: flex; justify-content: flex-end;">
										<input
											...
											class="flex-c-m stext-101 cl5 size-127 bg2 bor18 hov-btn3 p-lr-15 trans-04"
											type="button" onclick="cancelEditForm('${reply.reply_no}')"
											value="취소">
									</div>
								</form>
							</div>
...
<script>
	function toggleEditForm(reply_no, currentComment) {
	...
	function cancelEditForm(reply_no) {
		var editForm = document.getElementById('editForm_' + reply_no);
		editForm.style.display = 'none';
	}
</script>
