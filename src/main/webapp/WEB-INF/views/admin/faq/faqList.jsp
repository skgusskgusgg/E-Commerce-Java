					...
					<form method="post" action="faqdeleteSelected2">
						<table class="table-content-board">
							<tr class="table_head">
								...
								<th class="column-5">Views</th>
								<c:if test="${loginOK == 99}">
									<th class="column-5" colspan="2">
							...
							<c:forEach items="${list}" var="FAQ">
								<tr class="table_row">
									...
									<td class="column-2 has-img"><c:if
											test="${not empty FAQ.img}">
									...
									<td class="column-4">
									<c:out value="${FAQ.user_name}" />
									</td>
									<td class="column-5"><c:out value="${FAQ.updateDate}" /></td>
									<td class="column-5"><c:out value="${FAQ.viewCount}" /></td>
									<c:if test="${loginOK == 99}">
										<td class="column-5"><a class="new-button-edit"
