		...
		<div class="row" style="width: 100%">
			<div style="width: 100%">
						...
						<table class="table-content-board">
							...
							<c:forEach items="${list}" var="board">
								<tr class="table_row">
									...
									<td class="column-3"><a
										href="/admin/board/boardDetail?board_id=${board.board_id}"
									...
									<c:if test="${loginOK == 99}">
										<td class="column-6"><a class="new-button-edit"
											href="/admin/board/boardEdit?board_id=${board.board_id}">수정</a></td>
									</c:if>
								</tr>
							</c:forEach>
						</table>
				...
				<div class="flex-l-m flex-w w-full p-t-10 m-lr-7">
					<c:if test="${prev}">
						<span> <a
							href="/admin/board/boardListPage?page=${startPageNum - 1}"
					...
					<c:if test="${next}">
						<span> <a
							href="/admin/board/boardListPage?page=${endPageNum + 1}"
							class="flex-c-m how-pagination1 trans-04 m-all-7">></a>
						</span>
					</c:if>


					<a href="/admin/board/boardWrite"
